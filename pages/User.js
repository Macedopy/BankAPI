...
function User() {
    ...
    return (
        <div className={styles['container']}>
            ...
            <header data-role="Header" className={styles['cabecalho']}>
                <div className={styles['saldo-grp']}>
                    <div className={styles['dados-saldo-grp']}>
                        <span className={styles['bancaxi']}>
                            <span>Bancaxi</span>
                            <br></br>
                        </span>
                    </div>
                    <span className={styles['saldo']}>R&#36;{valueUpdated}</span>
                </div>
                <div className={styles['container1']}>
                    <div className={styles['dados']}>
                        ...
                        <span className={styles['idade']}>Idade: {age}</span>
                    </div>
                </div>
            ...
            <div className={styles['actions']}>
                <div className={styles['deposito-grp']}>
                    <a
                        onClick={() => navigate("/Deposit")}
                        target="_blank"
                        rel="noreferrer noopener"
                        className={styles['deposito']}
                    >
                        <span>Depósito</span>
                        <br></br>
                    </a>
                    <a onClick={() => navigate("/Consume")}
                        target="_blank"
                        rel="noreferrer noopener"
                        className={styles['saque']}
                    >
                        Saque
                    </a>
                </div>
                <div className={styles['transferencia-grp']}>
                    <a
                        onClick={() => navigate("/Transfer")}
                        target="_blank"
                        rel="noreferrer noopener"
                        className={styles['transferencia']}
                    >
